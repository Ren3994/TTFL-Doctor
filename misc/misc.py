...
CHECKSUM = 'e9daf51a48237383ae72290746628bc82ac38afb02e1535f2e88b553a9ae48af'
HIST_DB_URL = 'https://github.com/Ren3994/TTFL-Doctor/releases/download/data_v1.4/historical_data.db.zst'
...
TRICODE2FULLNAME = {v: k for k, v in FULLNAME2TRICODE.items()}
...
TEAM_NICKNAMES = {
    ...
    'PACKERS' : 'Anderson Packers',
    'BULLETS' : 'Baltimore Bullets',
    'WARRIORS' : 'Golden State Warriors',
    'GOLDEN' : 'Golden State Warriors',
    'STATE' : 'Golden State Warriors',
    'SAN' : 'San Antonio Spurs',
    'SAN ANTONIO' : 'San Antonio Spurs',
    'SPURS' : 'San Antonio Spurs',
    'FRANCISCO' : 'San Francisco Warriors',
    'HUSKIES' : 'Toronto Huskies',
    'PISTONS' : 'Detroit Pistons',
    'DETROIT' : 'Detroit Pistons',
    'NEW' : 'New York Knicks',
    'YORK' : 'New York Knicks',
    'KNICKS' : 'New York Knicks',
    'BOSTON' : 'Boston Celtics',
    'CELTICS' : 'Boston Celtics',
    'STAGS' : 'Chicago Stags',
    'PROVIDENCE' : 'Providence Steamrollers',
    'STEAMROLLERS' : 'Providence Steamrollers',
    'FALCONS' : 'Detroit Falcons',
    'BOMBERS' : 'St. Louis Bombers',
    'LAKERS' : 'Los Angeles Lakers',
    'PITTSBURGH' : 'Pittsburgh Ironmen',
    'LOS ANGELES' : 'Los Angeles Lakers',
    'LOS' : 'Los Angeles Lakers',
    'ANGELES' : 'Los Angeles Lakers',
    'LA' : 'Los Angeles Lakers',
    'KINGS' : 'Sacramento Kings',
    'ROYALS' : 'Rochester Royals',
    'HAWKS' : 'Atlanta Hawks',
    'INDIANAPOLIS' : 'Indianapolis Pacers',
    'INDY' : 'Indianapolis Pacers',
    ...
    'SAN DIEGO' : 'San Diego Rockets',
    'DIEGO' : 'San Diego Rockets',
    'MILWAUKEE' : 'Milwaukee Bucks',
    'BUCKS' : 'Milwaukee Bucks',
    'ST LOUIS' : 'St. Louis Hawks',
    'ST' : 'St. Louis Hawks',
    'ST.' : 'St. Louis Hawks',
    'LOUIS' : 'St. Louis Hawks',
    'ST. LOUIS' : 'St. Louis Hawks',
    'SAINT LOUIS' : 'St. Louis Hawks',
    'REBELS' : 'Cleveland Rebels',
    ...
    'JETS' : 'Indianapolis Jets',
    'FORT WAYNE' : 'Fort Wayne Pistons',
    'FORT' : 'Fort Wayne Pistons',
    'WAYNE' : 'Fort Wayne Pistons',
    'MINNEAPOLIS' : 'Minneapolis Lakers',
    'SACRAMENTO' : 'Sacramento Kings',
    'ROCHESTER' : 'Rochester Royals',
    'CINCINNATI' : 'Cincinnati Royals',
    'KANSAS' : 'Kansas City Kings',
    'OKLAHOMA CITY' : 'Oklahoma City Thunder',
    'OKLAHOMA' : 'Oklahoma City Thunder',
    'CITY' : 'Oklahoma City Thunder',
    'CAPITOLS' : 'Washington Capitols',
    'ATLANTA' : 'Atlanta Hawks',
    'TRI-CITIES' : 'Tri-Cities Blackhawks',
    'TRICITIES' : 'Tri-Cities Blackhawks',
    'TRI CITIES' : 'Tri-Cities Blackhawks',
    'TRI' : 'Tri-Cities Blackhawks',
    'CITIES' : 'Tri-Cities Blackhawks',
    'BLACKHAWKS' : 'Tri-Cities Blackhawks',
    'DENVER' : 'Denver Nuggets',
    'NUGGETS' : 'Denver Nuggets',
    'PACERS' : 'Indianapolis Pacers',
    'OLYMPIANS' : 'Indianapolis Olympians',
    'SHEBOYGAN' : 'Sheboygan Redskins',
    'REDSKINS' : 'Sheboygan Redskins',
    'WATERLOO' : 'Waterloo Hawks',
    'ANDERSON' : 'Anderson Packers',
    'SYRACUSE' : 'Syracuse Nationals',
    ...
    'ANTONIO' : 'San Antonio Spurs',
    'MAVERICKS' : 'Dallas Mavericks',
    'PELICANS' : 'New Orleans Pelicans',
    'IRONMEN' : 'Pittsburgh Ironmen'
    }

FRANCHISE_FILTERS = {
    'Washington Wizards' : """(
        (teamTricode = 'WAS' AND season >= '1974-75') OR 
        (teamTricode = 'CAP') OR (teamTricode = 'BLT') OR 
        (teamTricode = 'CHZ') OR (teamTricode = 'CHP'))
        """,
    'Chicago Packers' : "(teamTricode = 'CHP')",
    'Chicago Zephyrs' : "(teamTricode = 'CHZ')",
    'Washington Bullets' : "(teamTricode = 'BLT')",
    'Capital Bullets' : "(teamTricode = 'CAP')",
    'Toronto Huskies' : "(teamTricode = 'HUS')",
    'New York Knicks' : "(teamTricode = 'NYK')",
    'Boston Celtics' : "(teamTricode = 'BOS')",
    'Chicago Stags' : "(teamTricode = 'CHS')",
    'Providence Steamrollers' : "(teamTricode = 'PRO')",
    'Detroit Falcons' : "(teamTricode = 'DEF')",
    'St. Louis Bombers' : "(teamTricode = 'BOM')",
    'Pittsburgh Ironmen' : "(teamTricode = 'PIT')",
    'Cleveland Rebels' : "(teamTricode = 'CLR')",
    'Golden State Warriors' : """(
        (teamTricode = 'PHW') OR (teamTricode = 'SFW') OR
        (teamTricode = 'GOS') OR (teamTricode = 'GSW'))
        """,
    'San Francisco Warriors' : "(teamTricode = 'SFW')",
    'Philadelphia Warriors' : "(teamTricode = 'PHW')",
    'Baltimore Bullets' : "(teamTricode = 'BAL')",
    'Indianapolis Jets' : "(teamTricode = 'JET')",
    'Detroit Pistons' : "(teamTricode = 'FTW' OR teamTricode = 'DET')",
    'Fort Wayne Pistons' : "(teamTricode = 'FTW')",
    'Los Angeles Lakers' : "(teamTricode = 'MNL' OR teamTricode = 'LAL')",
    'Minneapolis Lakers' : "(teamTricode = 'MNL')",
    'Sacramento Kings' : """(
        (teamTricode = 'ROC') OR (teamTricode = 'CIN') OR
        (teamTricode = 'KCK') OR (teamTricode = 'SAC'))
        """,
    'Rochester Royals' : "(teamTricode = 'ROC')",
    'Cincinnati Royals' : "(teamTricode = 'CIN')",
    'Kansas City Kings' : "(teamTricode = 'KCK')",
    'Washington Capitols' : "(teamTricode = 'WAS' AND season <= '1950-51')",
    'Atlanta Hawks' : """(
        (teamTricode = 'TCB') OR (teamTricode = 'MIH') OR
        (teamTricode = 'STL') OR (teamTricode = 'ATL'))
        """,
    'Tri-Cities Blackhawks' : "(teamTricode = 'TCB')",
    'Milwaukee Hawks' : "(teamTricode = 'MIH')",
    'St. Louis Hawks' : "(teamTricode = 'STL')",
    'Denver Nuggets' : "(teamTricode = 'DEN' OR teamTricode = 'DN')",
    'Indianapolis Pacers' : "(teamTricode = 'IND')",
    'Indianapolis Olympians' : "(teamTricode = 'INO')",
    'Sheboygan Redskins' : "(teamTricode = 'SHE')",
    'Waterloo Hawks' : "(teamTricode = 'WAT')",
    'Anderson Packers' : "(teamTricode = 'AND')",
    'Philadelphia 76ers' : "(teamTricode = 'SYR' OR teamTricode = 'PHL' OR teamTricode = 'PHI')",
    'Syracuse Nationals' : "(teamTricode = 'SYR')",
    'Chicago Bulls' : "(teamTricode = 'CHI')",
    'Oklahoma City Thunder' : "(teamTricode = 'SEA' OR teamTricode = 'OKC')",
    'Seattle SuperSonics' : "(teamTricode = 'SEA')",
    'Houston Rockets' : "(teamTricode = 'SDR' OR teamTricode = 'HOU')",
    'San Diego Rockets' : "(teamTricode = 'SDR')",
    'Milwaukee Bucks' : "(teamTricode = 'MIL')",
    'Phoenix Suns' : "(teamTricode = 'PHX')",
    'Cleveland Cavaliers' : "(teamTricode = 'CLE')",
    'Los Angeles Clippers' : "(teamTricode = 'BUF' OR teamTricode = 'SDC' OR teamTricode = 'LAC')",
    'San Diego Clippers' : "(teamTricode = 'SDC')",
    'Buffalo Braves' : "(teamTricode = 'BUF')",
    'Portland Trail Blazers' : "(teamTricode = 'POR')",
    'Utah Jazz' : "(teamTricode = 'NOJ' OR teamTricode = 'UTH' OR teamTricode = 'UTA')",
    'New Orleans Jazz' : "(teamTricode = 'NOJ')",
    'San Antonio Spurs' : "(teamTricode = 'SAN' OR teamTricode = 'SAS')",
    'Brooklyn Nets' : "(teamTricode = 'NYN' OR teamTricode = 'NJN' OR teamTricode = 'BKN')",
    'New York Nets' : "(teamTricode = 'NYN')",
    'New Jersey Nets' : "(teamTricode = 'NJN')",
    'Dallas Mavericks' : "(teamTricode = 'DAL')",
    'New Orleans Pelicans' : """(
        (teamTricode = 'NOH') OR
        (teamTricode = 'NOK') OR (teamTricode = 'NOP'))
        """,
    'New Orleans Hornets' : "(teamTricode = 'NOH' OR teamTricode = 'NOK')",
    'Miami Heat' : "(teamTricode = 'MIA')",
    'Minnesota Timberwolves' : "(teamTricode = 'MIN')",
    'Orlando Magic' : "(teamTricode = 'ORL')",
    'Toronto Raptors' : "(teamTricode = 'TOR')",
    'Memphis Grizzlies' : "(teamTricode = 'VAN' OR teamTricode = 'MEM')",
    'Vancouver Grizzlies' : "(teamTricode = 'VAN')",
    'Charlotte Hornets' : "(teamTricode = 'CHH' OR teamTricode = 'CHA')"
}
