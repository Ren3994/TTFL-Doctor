...
from streamlit_interface.player_stats_utils import cached_player_stats, cached_player_v_team, cached_historique_des_perfs, get_maximums
...
def clear_after_db_update():
    ...
    cached_player_v_team.clear()
    cached_historique_des_perfs.clear()
    get_maximums.clear()
