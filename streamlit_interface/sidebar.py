...
def sidebar(page):
    ...
    st.sidebar.page_link('pages/4_Stats_par_equipes.py', label='4 - Stats par équipes (WIP)')
    st.sidebar.page_link('pages/5_Stats_par_joueurs.py', label='5 - Stats par joueurs (WIP)')
