...
def sidebar(page):
    ...
    st.sidebar.page_link('pages/5_Stats_par_equipes.py', label='5 - Stats par équipes')
    st.sidebar.page_link('pages/6_Stats_par_joueurs.py', label='6 - Stats par joueurs')
