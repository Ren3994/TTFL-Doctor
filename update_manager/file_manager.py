...
def cleanup_db():
    for table in ['team_games', 'played', 'teammate_played', 'rel_avg_opp_TTFL', 'home_away_rel_TTFL', 'avg_TTFL_per_pos', 'rel_patop', 'absent_teammate_rel_impact', 'games_missed_by_players', 'opp_pos_avg_per_game', 'injury_report']:
        drop_table(table)
